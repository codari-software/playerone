        ...
        <div className="p-[2px] pixel-corners bg-[#333333] shadow-2xl shadow-[#ff6b6b]/10">
          <div className="pixel-corners bg-[#18181b] p-8">
            <div className="flex flex-col items-center mb-8 border-b-2 border-[#333] pb-6">
              <h1 className="font-press-start text-xl text-[#ff6b6b] mb-4 text-center tracking-widest leading-loose">CRIAR PERSONAGEM</h1>
              <p className="text-gray-400 text-center text-2xl uppercase">Inicie sua jornada épica no mundo real</p>
            </div>
